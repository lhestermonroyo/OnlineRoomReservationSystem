  ...
  <div class="carousel-inner" style="height: 580px;">
    <div class="item active">
      ...
      <div class="carousel-caption">
        ...
        <a href="signup.php" class="btn btn-warning btn-lg margin-bottom-lg">Sign Up <i class="fa fa-pencil-alt fa-fw"></i></a>
        <a href="login.php" class="btn btn-warning btn-lg margin-bottom-lg">Log In <i class="fa fa-sign-in-alt fa-fw"></i></a>
      </div>
    </div>
    <div class="item">
